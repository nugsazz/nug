...
💞[Title:]
 ...
 ✍̶̶ե̶̶ҽ̶̶α̶̶ต̶ ̶ճ̶̶օ̶̶ե̶ ̶հ̶̶α̶̶ղ̶̶s̶̶k̶̶í̶̶l̶̶l̶̶s̶✈
"""
...
#-----------------------------------------------
		...
		for ticket_id in n_links:
			if wait["atjointicket"] == True:
                ...
                ki.sendText(msg.to,Amid)
            elif "Say2 mid" == msg.text:
                kk.sendText(msg.to,Bmid)
            elif "Say3 mid" == msg.text:
                kc.sendText(msg.to,Cmid)
...
#-----------------------------------------------
                ...
                ki.sendText(msg.to,"Say1")
                kk.sendText(msg.to,"Say2")
                kc.sendText(msg.to,"Say3")
#-----------------------------------------------
